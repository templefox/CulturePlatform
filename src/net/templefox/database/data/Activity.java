...
public class Activity extends Entity implements java.io.Serializable, Comparable<Activity> {
	...
	public Activity(int user, String location, String name, String address, String content, String type, String theme, Date data,
			Date time, String procedure, String pictureUrl, String reporterInfo, int temperature) {
		this.user = user;
	...
	@Override
	public Activity resolveJSON(JSONObject obj) throws JSONException, ParseException {
